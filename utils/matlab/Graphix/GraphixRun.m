...
if LoadData
        ...
        for intrl = 1:ntrl
            ...
            if isequal(ExpInfo,'Empty')
                ...
                [data{inplot}{intrl},xax{inplot}{intrl},...
                 ...
                 pltslc{inplot}{intrl}] = GraphixLoad(...
    ...
    save('GraphixDump.mat','data','xax','yax','time','pltslc');
else
...
GraphixPlot(plotparam,plotparamvalue,pagename,page,data,xax,yax,time,...
            pltslc,OutputDir,LoadGridData,SavePlots,GraphixDebug);