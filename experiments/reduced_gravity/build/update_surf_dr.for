        ...
        DO j=1-Oly,sNy+Oly
         DO i=1-Olx,sNx+Olx
          ...
          IF (ks.LE.Nr) THEN
           ...
           recip_hFacC(i,j,ks,bi,bj)= 1.D0 / hFac_surfNm1C(i,j,bi,bj)
          ENDIF
         ENDDO
        ENDDO
        ...
        DO j=1-Oly,sNy+Oly
         DO i=2-Olx,sNx+Olx
          ...
          IF (ks.LE.Nr) THEN
           ...
           recip_hFacW(i,j,ks,bi,bj)= 1.D0 / hFac_surfNm1W(i,j,bi,bj)
          ENDIF
         ENDDO
        ENDDO
        DO j=2-Oly,sNy+Oly
         DO i=1-Olx,sNx+Olx
          ...
          IF (ks.LE.Nr) THEN
           ...
           recip_hFacS(i,j,ks,bi,bj)= 1.D0 / hFac_surfNm1S(i,j,bi,bj)
          ENDIF
         ENDDO
        ENDDO
         ...
         DO j=1-Oly,sNy+Oly
          DO i=1-Olx,sNx+Olx
           ...
           IF (h0FacC(i,j,k,bi,bj) .NE. 0. ) THEN
            recip_hFacC(i,j,k,bi,bj) = 1.D0 / h0FacC(i,j,k,bi,bj)
           ELSE
