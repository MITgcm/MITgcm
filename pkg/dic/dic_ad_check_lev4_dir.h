...
C common dic_load
CADJ STORE dicwind0,dicwind1   = tapelvs4, key = ilev_4
CADJ STORE ice0,ice1         = tapelvs4, key = ilev_4
CADJ STORE atmosp0,atmosp1   = tapelvs4, key = ilev_4
CADJ STORE silica0,silica1   = tapelvs4, key = ilev_4
#ifdef ALLOW_FE
CADJ STORE feinput0,feinput1 = tapelvs4, key = ilev_4
#endif
