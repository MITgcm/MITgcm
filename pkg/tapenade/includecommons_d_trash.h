...
C
     ...
     +v2zondir, fcori, fcorig, fcoricos
      ...
      REAL*8 etand(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 uvel(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      REAL*8 uveld0(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      REAL*8 vvel(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      REAL*8 vveld0(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      REAL*8 wvel(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      REAL*8 wveld(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      REAL*8 theta(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      REAL*8 thetad(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      REAL*8 salt(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      REAL*8 saltd(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      REAL*8 gu(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      REAL*8 gud(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      REAL*8 gv(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      REAL*8 gvd(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      REAL*8 gunm1(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      REAL*8 gunm1d(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      REAL*8 gvnm1(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      REAL*8 gvnm1d(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      REAL*8 gtnm1(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      REAL*8 gtnm1d(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      REAL*8 gsnm1(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      REAL*8 gsnm1d(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
     ...
     +gunm1, gvnm1, gtnm1, gsnm1
      ...
      REAL*8 etahd(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      ...
      REAL*8 totphihydd(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      REAL*8 rhoinsitu(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      REAL*8 rhoinsitud(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
...
C
      ...
      REAL*8 detahdtd(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 pmepr(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 pmeprd(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      COMMON /exact_eta_local/ etahnm1, detahdt, pmepr
      REAL*8 fu(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 fud(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
C
C
C
C
...
C
      ...
      REAL*8 fvd(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      COMMON /ffields_fv/ fv
      REAL*8 qnet(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 qnetd(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
     ...
     +       )
      ...
      REAL*8 qnetmd(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      ...
      REAL*8 taux0d(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 tauy0(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 tauy0d(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 qnet0(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 qnet0d(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 empmr0(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 empmr0d(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 saltflux0(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 saltflux0d(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 sst0(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 sst0d(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 sss0(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 sss0d(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 taux1(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 taux1d(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 tauy1(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 tauy1d(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 qnet1(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 qnet1d(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 empmr1(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 empmr1d(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 saltflux1(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 saltflux1d(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 sst1(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 sst1d(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 sss1(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 sss1d(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
     ...
     +tauy1, qnet1, empmr1, sst1, sss1, saltflux0, saltflux1
      ...
      REAL*8 surfaceforcingud(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 surfaceforcingv(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 surfaceforcingvd(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 surfaceforcingt(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 surfaceforcingtd(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 surfaceforcings(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 surfaceforcingsd(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 surfaceforcingtice(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 surfaceforcingticed(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
C
C
     ...
     +       ndv3d)
      REAL*8 storedynvars3dd(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy
     +       , ndv3d)
      REAL*8 storedynvars2d(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy, 
     +       ndv2d)
      REAL*8 storedynvars2dd(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy, 
     +       ndv2d)
...
C
     ...
     +adamsbashforthgs, adamsbashforth_t, adamsbashforth_s
      ...
      REAL*8 uveldd(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      REAL*8 vveld(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      REAL*8 vveldd(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      REAL*8 etanm1(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 etanm1d(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 unm1(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      REAL*8 unm1d(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      REAL*8 vnm1(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      REAL*8 vnm1d(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
...
CHFLUXM_CONTROL
      ...
      REAL*8 xx_hfluxm_dummyd(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
CHFLUXM_CONTROL
...
CHFLUXM_CONTROL
      ...
      REAL*8 objf_hflux_tutd(nsx, nsy)
      REAL*8 objf_temp_tut(nsx, nsy)
      REAL*8 objf_temp_tutd(nsx, nsy)
...
CHFLUXM_CONTROL
     ...
     +multvvel, multetan, mult_hflux_tut, mult_temp_tut
      ...
      REAL*8 cmeanthetad(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
...
C
      ...
      REAL*8 kwxd(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      REAL*8 kwy(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      REAL*8 kwyd(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      REAL*8 kwz(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      REAL*8 kwzd(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      COMMON /gm_wtensor/ kwx, kwy, kwz
C
      REAL*8 kux(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      REAL*8 kuxd(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      REAL*8 kvy(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      REAL*8 kvyd(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      COMMON /gm_hortensor/ kux, kvy
C
      REAL*8 kuz(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      REAL*8 kuzd(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      REAL*8 kvz(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      REAL*8 kvzd(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
...
C
     ...
     +vzetatave, phihydtave, phihydlow2tave, convectcounttave
      ...
      COMMON /gm_uvtensor_d/ kuzd, kvzd
      COMMON /gm_hortensor_d/ kuxd, kvyd
      COMMON /gm_wtensor_d/ kwxd, kwyd, kwzd
      COMMON /cost_mean_r_d/ cmeanthetad
      COMMON /cost_objf_d/ objf_hflux_tutd, objf_temp_tutd
      COMMON /cost_r_d/ fcd
      COMMON /ctrl_dummy_d/ xx_hfluxm_dummyd
      COMMON /dynvars_cd_d/ uveldd, vveldd, etanm1d, unm1d, vnm1d
      COMMON /autodiff_store_dyn_d/ storedynvars3dd, storedynvars2dd
      COMMON /surface_forcing_d/ surfaceforcingud, surfaceforcingvd, 
     +surfaceforcingtd, surfaceforcingsd, surfaceforcingticed
      COMMON /tdfields_d/ taux0d, tauy0d, qnet0d, empmr0d, sst0d, sss0d
     +, taux1d, tauy1d, qnet1d, empmr1d, sst1d, sss1d, saltflux0d, 
     +saltflux1d
      COMMON /mean_qnet_d/ qnetmd
      COMMON /ffields_sss_d/ sssd
      COMMON /ffields_sst_d/ sstd
      COMMON /ffields_saltflux_d/ saltfluxd
      COMMON /ffields_empmr_d/ empmrd
      COMMON /ffields_qnet_d/ qnetd
      COMMON /ffields_fv_d/ fvd
      COMMON /ffields_fu_d/ fud
      COMMON /exact_eta_local_d/ detahdtd, pmeprd
      COMMON /surf_correc_d/ tsurfcord, ssurfcord
      COMMON /dynvars_diag_d/ totphihydd, rhoinsitud
      COMMON /dynvars_r_2_d/ etahd
      COMMON /dynvars_r_d/ etand, uveld0, vveld0, wveld, thetad, saltd, 
     +gud, gvd, gunm1d, gvnm1d, gtnm1d, gsnm1d
