C $Header: /u/gcmpack/MITgcm/pkg/autodiff/checkpoint_lev4_directives.h,v 1.23 2010/10/28 14:37:44 heimbach Exp $
C $Name:  $
c
...
cph-test(
CADJ STORE etahs,etahw     = tapelev4, key = ilev_4
CADJ STORE detasdt,detawdt = tapelev4, key = ilev_4
cph-test)
