...
C--
     ...
     &     objf_obcsN, objf_obcsS, objf_obcsE, objf_obcsW,
     &     objf_obcsvol, objf_ageos,
     &     num_obcsN, num_obcsS, num_obcsE, num_obcsW,
     &     num_obcsvol, num_ageos

      COMMON /ctrl_cost_mult_obcs/
     &     mult_obcsN, mult_obcsS, mult_obcsE, mult_obcsW,
...
C     defined by default.
     ...
     &     wobcsNLev, wobcsSLev, wobcsELev, wobcsWLev
