...
CADJ STORE atmosP            = tapelev3, key = ilev_3
CADJ STORE wind              = tapelev3, key = ilev_3
CADJ STORE silica            = tapelev3, key = ilev_3
CADJ STORE ak1               = tapelev3, key = ilev_3
CADJ STORE ak2               = tapelev3, key = ilev_3
CADJ STORE akf               = tapelev3, key = ilev_3
CADJ STORE ft                = tapelev3, key = ilev_3
