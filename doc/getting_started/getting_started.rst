...
+----------------------------------------+-----------+--------------------------------------------------+---------------------------------------------------------------------------------------------------------+
| :varlink:`selectCoriScheme`            | PARM01    | 0                                                | Coriolis scheme selector (=0 : original scheme; =1 : wet-point averaging method;                        |
|                                        |           |                                                  | =2, Flux-Form: energy conserving, Vector-Inv: hFac weighted average; =3, Flux-Form: energy conserving   |
|                                        |           |                                                  | using wet-point method, Vector-Inv: energy conserving with hFac weight)                                 |
+----------------------------------------+-----------+--------------------------------------------------+---------------------------------------------------------------------------------------------------------+
| :varlink:`useJamartWetPoints`          | PARM01    | FALSE                                            | set :varlink:`selectCoriScheme` to 1 (or 3) to use Jamart & Ozer ’86 Coriolis wetpoints method          |
+----------------------------------------+-----------+--------------------------------------------------+---------------------------------------------------------------------------------------------------------+
| :varlink:`useEnergyConservingCoriolis` | PARM01    | FALSE                                            | set :varlink:`selectCoriScheme` to 2 (or 3) to use energy-conserving discretization of Coriolis         |
+----------------------------------------+-----------+--------------------------------------------------+---------------------------------------------------------------------------------------------------------+
