...
:filelink:`verification/tutorial_reentrant_channel/input/gendata_50km.m` or
:filelink:`verification/tutorial_reentrant_channel/input/gendata.50km.py`).
...
Our primary focus in this section is a physical interpretation of the model solution,
...
`Jupyter Notebook <https://jupyter.org/>`_ format, at
...
can be generated using the `MATLAB <https://www.mathworks.com/>`_ program :filelink:`verification/tutorial_reentrant_channel/input/gendata.5km.m`
or `Python <https://www.python.org/>`_ script :filelink:`verification/tutorial_reentrant_channel/input/gendata.5km.py`
(don't forget to change the filenames in ``PARM05``
