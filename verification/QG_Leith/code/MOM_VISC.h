...
#ifdef GM_GERMANO
C     GM mixing/stirring coefficient, defined dynamically in the
C     Germano (1991) style
      _RL GermanoK(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      COMMON /GM_Germano/ GermanoK
#endif
