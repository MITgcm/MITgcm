...
tauMax=0.; # wind stress maximum
x=np.array(np.arange(nx)-1)/(nx-2) # x-coordinate, located at XG points
y=np.array(np.arange(ny)-.5)/(ny-2) # y-coordinate, located at YC points
