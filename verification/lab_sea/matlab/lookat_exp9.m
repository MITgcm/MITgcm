...
area2=readbin([exp9_path 'AREAtave.0000000010.data'],[20 16 1],1);
heff2=readbin([exp9_path 'HEFFtave.0000000010.data'],[20 16 1],1);
uice2=readbin([exp9_path 'UICEtave.0000000010.data'],[20 16 1],1);
vice2=readbin([exp9_path 'VICEtave.0000000010.data'],[20 16 1],1);
...
title('Sea-ice concentration with pkg/exf fluxes')
set(gca,'xticklabel',[])
