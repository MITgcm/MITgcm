...
% load model output
area1=readbin([exp8_path 'AREAtave.0000000010.data'],[20 16 1],1);
heff1=readbin([exp8_path 'HEFFtave.0000000010.data'],[20 16 1],1);
uice1=readbin([exp8_path 'UICEtave.0000000010.data'],[20 16 1],1);
vice1=readbin([exp8_path 'VICEtave.0000000010.data'],[20 16 1],1);
area2=readbin([exp10_path 'AREAtave.0000000010.data'],[20 16 1],1);
heff2=readbin([exp10_path 'HEFFtave.0000000010.data'],[20 16 1],1);
uice2=readbin([exp10_path 'UICEtave.0000000010.data'],[20 16 1],1);
vice2=readbin([exp10_path 'VICEtave.0000000010.data'],[20 16 1],1);
...
title('Sea-ice concentration with pkg/exf evaporation')
set(gca,'xticklabel',[])

subplot(322)
mypcolor(lon,lat,area2'-area1'); colorbar
title('Difference with Experiment 8')
set(gca,'xticklabel',[])
