C $Header: /u/gcmpack/MITgcm/verification/offline_exf_seaice/code_ad/DIAGNOSTICS_SIZE.h,v 1.1 2007/06/25 20:15:43 heimbach Exp $
C $Name:  $
...
C  and "diagSt_size" (statistics-diags) since values here are deliberately small.
      ...
      PARAMETER( numlists = 20, numperlist = 50, numLevels=2*Nr )
      PARAMETER( numdiags = 15+1*Nr )
