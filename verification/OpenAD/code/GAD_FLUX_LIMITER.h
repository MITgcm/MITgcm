C $Header: /u/gcmpack/MITgcm/verification/OpenAD/code/Attic/GAD_FLUX_LIMITER.h,v 1.1 2005/08/19 21:48:51 heimbach Exp $
C $Name:  $
...
cph(
cph Statement functions obsolete in F90
c     Limiter(Cr)=0.
c     Limiter(Cr)=1.
cph      Limiter(Cr)=max(0.D0,max(min(1.D0,2.D0*Cr),
cph     &                         min(2.D0,Cr))) 
cph)
