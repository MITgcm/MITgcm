...
C o Include/exclude kinetic energy monitor that writes to errorMessageUnit
#define INCLUDE_KINETIC_ENERGY_MONITOR

C o Include/exclude code for AIM package
#undef  ALLOW_AIM

C o Include/exclude float integration scheme
#define ALLOW_FLT
