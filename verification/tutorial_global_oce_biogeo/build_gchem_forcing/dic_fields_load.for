...
CEOP
      ...
      IF (  DIC_forcingCycle.GT.0.D0 ) THEN
...
C--   fill-in overlap after loading temp arrays:
        CALL EXCH_XY_RS ( dicwind0,  myThid  )
        CALL EXCH_XY_RS ( dicwind1,  myThid  )
        CALL EXCH_XY_RS ( atmosp0,  myThid  )
        CALL EXCH_XY_RS ( atmosp1,  myThid  )
        CALL EXCH_XY_RS ( silicaSurf0,  myThid  )
        CALL EXCH_XY_RS ( silicaSurf1,  myThid  )
