...
C--   COMMON /GCHEM_FIELDS_C/
     ...
     &    gchem_3DSiFile
      ...
      CHARACTER*128 gchem_3DSiFile

C--   COMMON /GCHEM_FIELDS_R/
      COMMON /GCHEM_FIELDS_R/
     &     gchem_Si_const, gchem_3DSi_const, gchem_par_const, 
     &     gchem_Fe_const, gchem_apco2_const, gchem_wind_const, 
     &     gchem_apres_const, gchem_chl_const, gchem_ice_const

      Real*8 gchem_Si_const
      Real*8 gchem_3DSi_const
      Real*8 gchem_par_const
      Real*8 gchem_Fe_const
      Real*8 gchem_apco2_const
      Real*8 gchem_wind_const
      Real*8 gchem_apres_const
      Real*8 gchem_chl_const
      Real*8 gchem_ice_const
