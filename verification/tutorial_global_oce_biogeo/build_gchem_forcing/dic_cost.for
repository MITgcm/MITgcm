...
c DIC_COST.h
         Real*8 totcost
c control variables
cQQ      Real*8 alpha(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
cQQ      Real*8 rain_ratio(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
cQQ      Real*8 KScav
cQQ      Real*8 ligand_stab
cQQ      Real*8 ligand_tot
