...
C  Note: 1) tracers that use  are not counted here
...
C--   COMMON /GCHEM_LOAD_I/
      ...
      Real*8 gchemChl0(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      Real*8 gchemChl1(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
