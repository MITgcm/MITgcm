...
c     Real*8 feload(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
     ...
     &              atpco2
       ...
       Real*8 co2atmos(1000)
       Real*8 total_atmos_carbon
       Real*8 total_ocean_carbon
       Real*8 total_atmos_carbon_year
       Real*8 total_atmos_carbon_start
       Real*8 total_ocean_carbon_year
       Real*8 total_ocean_carbon_start
       Real*8 atpco2
