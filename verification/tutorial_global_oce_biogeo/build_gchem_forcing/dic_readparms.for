...
C-- setting default values for Calcite Saturation params ends here.
       ...
       KFE         = 1.2D-7
       alpfe       = 0.01D0
       fesedflux_pcm = 6.8D-4 * 106.D0
       FeIntSec    = 0.5D-6 / 86400.D0
       freefemax   = 3.D-7
       KScav       = 0.19D0/(360.D0*86400.D0)
       ligand_stab = 1.D8
       ligand_tot  = 1.D-6
       alphaUniform     = 2.D-3/(360.D0 * 86400.D0)
       rainRatioUniform = 7.D-2
...
C---+----1----+----2----+----3----+----4----+----5----+----6----+----7-|--+----|
      ...
      IF ( dic_int1.EQ.0 .AND. dic_pCO2.NE.278.D-6 ) THEN
        WRITE(msgBuf,'(A)')
