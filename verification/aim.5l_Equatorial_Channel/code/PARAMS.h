C $Header: /u/gcmpack/MITgcm/verification/aim.5l_Equatorial_Channel/code/Attic/PARAMS.h,v 1.2 2001/02/02 21:36:30 adcroft Exp $
C
C     /==========================================================\
C     | PARAMS.h                                                 |
...
C Logical flags for selecting packages
     ...
     &        useKPP, useGMRedi, useECCO, useAIM
