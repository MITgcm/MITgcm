C $Header: /u/gcmpack/MITgcm/verification/aim.5l_Equatorial_Channel/code/Attic/EEPARAMS.h,v 1.2 2005/09/12 12:33:40 edhill Exp $
C $Name:  $
CBOP
...
C     useCoupler  - use Coupler for a multi-components set-up
     ...
     &  useCubedSphereExchange, useCoupler, useSETRLSTK
      LOGICAL eeBootError
      LOGICAL eeEndError
      LOGICAL fatalError
